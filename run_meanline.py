...
fan = ml.Fan(Mach_inlet=0.6, AR_rotor=7, AR_stator=10, taper_rotor=2, taper_stator=0.5, n=1, no_blades_rotor=18,
             no_blades_stator=60, beta_tt=1.6, P0_cruise=39513.14, T0_cruise=250.13, mdot=80, omega=5000,
             hub_tip_ratio=0.8, gamma=1.4, R_air=287, eta_tt_estimated=0.9, row_chord_spacing_ratio=0.5, lieblein_model=lieblein_model,
             profile="NACA-65", methodology="free vortex")
ml.Fan_Plots(fan)

print(fan.eta_tt_estimated)

fan_optimisation_problem = ml.optimize_design()
